...
class Line4{
	...
	private function creatingFirstTxtSection(){
		...
		$notice .= '</div>';
		self::$firstTxtSection = '<div id="ln4-firstTxtSection">'.$notice.'<span><img src="" /></span></div>';
	}
	...
	private function creatingFifthTxtSection(){
		$txtLine = '<div id="ln4-5thSecInputWrapper"><input id="" type="button" value="Play" /></div>';
		self::$fifthTxtSection = '<div id="ln4-fifthTxtSection">'.$txtLine.'</div>';
	}
	
	private function creatingLine4(){
		$cont = '<div id="line4" class="lines">';
