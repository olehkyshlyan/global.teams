...
class Line7{
	...
	private function creatingFirstTxtSection(){
		...
		$secondArrow .= '</div>';
		self::$firstTxtSection = '<div id="ln7-firstTxtSection">'.$notice.$logo.$firstArrow.$secondArrow.'</div>';
	}
	...
	private function creatingThirdTxtSection(){
		...
		$txtLines .= '<div id="ln7-3rdSecLines">';
	...
	private function creatingFifthTxtSection(){
		$txtLine = '<div id="ln7-5thSecInputWrapper"><input id="ln7-5thSecInput" class="ln-5thSecInput" type="button" value="Play" /></div>';
